...
<body>
	...
	<a href="querystring?name=ㅇㄷㄷ&age=12&birthday=2024-06-15&gender=F&national=ko&hobbies=movie&hobbies=music&hobbies=sleep">쿼리스트링을 이용한 값 전달</a>
	...
	<form action="formdata" method="post">
		...
		<label>생일 :</label><input type="date" name="birthday"><br>
		<label>성별 :</label>
		<!--label for 글자를 눌러도 선택이 되는 속성 뒤에 오는 건 아이디값  -->
